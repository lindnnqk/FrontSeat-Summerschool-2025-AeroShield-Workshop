...
%   Edited by Nora Lindner for Teensy Hardware
%   Edited on: 02.09.2025
clear
close all
clc

% load data collected for identification
load IdentificationData.mat % TODO: check filename
yrad = collecteddata(:,1);
u = collecteddata(:,2);
clear collecteddata;
...
% load data collected for validation
load ValidationData.mat % TODO: check filename
yradval = collecteddata(:,1);
uval = collecteddata(:,2);
clear collecteddata;
