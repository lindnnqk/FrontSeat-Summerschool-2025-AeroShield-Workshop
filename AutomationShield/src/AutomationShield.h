...
// Common definitions
  ...
  #define ADCREF 1023.0 // Teensy Default is 10bit, but can be modifed to 12bit, check doc if neccessary, only tested for AeroShield, but modified to also make FloatShield compile.
#endif
