/*
  ...
  Teensy Timer:  Benedikt Lammersmann, 2025 (Teensy 4.1 with IntervalTimer Lib)
  Last update: 22.08.2025 by Benedikt Lammersmann
*/ 
...
void TC5_Handler(void){
 ...
 (Sampling.getInterruptCallback())();
  ...
  #include "sampling/SamplingTeensy_ISR.h"
