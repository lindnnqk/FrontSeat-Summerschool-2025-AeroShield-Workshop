...
namespace SamplingNoServo {
    ...
    class SamplingClass {
      ...
      private:
            ...
            IntervalTimer Timer; // Timer object from Teensy InvervalTimer Library.
            const unsigned char cpuFrequency = 180; // Actuallly not needed, as IntervalTimer is used, however added for compatibillity.
