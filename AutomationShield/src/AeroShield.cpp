...
float AeroClass::begin(void){                                 // Board initialisation
  #if  defined(ARDUINO_ARCH_AVR) || defined(ARDUINO_ARCH_SAMD) || defined(ARDUINO_ARCH_RENESAS_UNO) || defined(TEENSYDUINO) // For AVR, SAMD, Renesas architecture boards and Teensy!
